...
Charlie.
  ...
  return (
    <div className="flex flex-col bg-dark-500 w-2/3">
      <span className="text-2xs text-center text-light-200 my-6">13 / 13</span>
      ...
      <span className="px-10 text-2xs text-light-200 font-bold mt-6">
        3:30PM
      </span>
      <span className="px-10 text-lg text-light-100 font-light mb-6">
        How are you getting on?
      </span>
      <div className="px-10 text-xs text-light-200 whitespace-pre">{body}</div>
    </div>
  );
}