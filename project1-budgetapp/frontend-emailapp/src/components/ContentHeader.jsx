import { faEnvelope, faMagnifyingGlass, faFolder, faBell } from '@fortawesome/free-solid-svg-icons';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';

export default function ContentHeader() {
  return(
    <div className='bg-dark-500 flex items-center py-6 px-10 mb-1'>
      <FontAwesomeIcon icon={faMagnifyingGlass} className="text-xl text-light-300"/>
      <input placeholder='Search...' className='w-4/12 mr-auto ml-4 bg-transparent outline-none' />
